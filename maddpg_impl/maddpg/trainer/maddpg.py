...
from maddpg_impl.maddpg import AgentTrainer
from maddpg_impl.maddpg.trainer.replay_buffer import ReplayBuffer
...
class MADDPGAgentTrainer(AgentTrainer):
    def __init__(self, name, model, obs_shape_n, act_space_n, agent_index, args, local_q_func=False, agent=None):
        self.name = name
        ...
        self.max_replay_buffer_len = args.batch_size * 100
